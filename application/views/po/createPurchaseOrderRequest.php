<div class="content-box content-box-header">
  <div class="content-box-wrapper">
    ...
    <?php 
		...
		echo form_open_multipart(base_url() . 'index.php/po/purchase_order/add_po'); 
		?>
    <fieldset>
      <table width="100%" border="1px" class="flexme2">
        <tr>
          <td colspan="1" style="padding: 5px 5px 5px 0;"><b>Supplier Type *</b></td>
          <td colspan="3" style="padding: 5px 5px 5px 0;"><select id="sup_type" class="field select full" name="cmb_sup_type" onchange="select_currency();">
              <option value=""></option>
          ...
          <td colspan="3" style="padding: 5px 5px 5px 0;"><input type="text" id="sup_name" class="field text full" name="txt_sup_name" />
            <script type="text/javascript">
        ...
        <tr>
          ...
          <td style="padding: 5px 5px 5px 0;"><input type="text" id="ord_date" class="field text full" name="txt_ord_date" value="<?php echo date("Y-m-d"); ?>" readonly="readonly"/></td>
          <td style="padding: 5px 5px 5px 0;"><b>Expected Date</b></td>
          <td style="padding: 5px 5px 5px 0;"><input type="text" id="exp_date" class="field text full" name="txt_exp_date" /></td>
          <td style="padding: 5px 5px 5px 0;"><b>Quotation No.</b></td>
          <td style="padding: 5px 5px 5px 0;"><input type="text" id="quote_no" class="field text full" name="txt_quote_no" /></td>
          <td style="padding: 5px 5px 5px 0;"><b>Attention</b></td>
          <td style="padding: 5px 5px 5px 0;"><input type="text" id="attention" class="field text full" name="txt_attention" /></td>
        </tr>
        <tr>
          <td colspan="1" style="padding: 5px 5px 5px 0;"><b>Department *</b></td>
          <td colspan="3" style="padding: 5px 5px 5px 0;"><select id="req_dept" class="field select full" name="cmb_req_dept">
              <option value=""></option>
              <?php
          ...
          <td colspan="3" style="padding: 5px 5px 5px 0;"><select id="req_by" class="field select full" name="cmb_req_by">
              <?php
        ...
        <tr>
          ...
          <td colspan="3" style="padding: 5px 5px 5px 0;"><select id="pay_type" class="field select full" name="cmb_pay_type">
              <option value=""></option>
              <?php
          ...
          <td style="padding: 5px 5px 5px 0;"><select id="curr" class="field select full" name="cmb_curr" onchange="select_conv_rate();">
              <option value=""></option>
              <?php
          ...
          <td style="padding: 5px 5px 5px 0;"><input type="text" id="con_rate" class="field text full" name="txt_con_rate" />
            <script type="text/javascript">
